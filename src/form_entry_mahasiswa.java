...
public class form_entry_mahasiswa extends javax.swing.JDialog { //Inheritance

    public form_entry_mahasiswa(java.awt.Frame parent, boolean modal) {
        //Inheritance dari class form_entry_mahasiswa
        super(parent, modal);
        initComponents();
        tampil_tb_mahasiswa();
    }
    ...
    private void tb_mahasiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_mahasiswaMouseClicked
        ...
        kliktable(); //Polymorphisme dari Kelas Kliktable;
    }//GEN-LAST:event_tb_mahasiswaMouseClicked

    //reset 
    public void reset(){ //Inheritance dari class form_entry_mahasiswa
        txt_jurusan.setText("");
        txt_nama.setText("");
        txt_no_bp.setText("");
    ...
    private void resetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetActionPerformed
        // TODO add your handling code here:
        reset(); //Polymorphisme dari Kelas reset
    ...
    public static void main(String args[]) {
        ...
        } catch (ClassNotFoundException ex) { //POLYMORFISM Metodenya sama tetapi Parameter berbeda
            java.util.logging.Logger.getLogger(form_entry_mahasiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) { //POLYMORFISM Metodenya sama tetapi Parameter berbeda
            java.util.logging.Logger.getLogger(form_entry_mahasiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) { //POLYMORFISM Metodenya sama tetapi Parameter berbeda
            java.util.logging.Logger.getLogger(form_entry_mahasiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (javax.swing.UnsupportedLookAndFeelException ex) { //POLYMORFISM Metodenya sama tetapi Parameter berbeda
            java.util.logging.Logger.getLogger(form_entry_mahasiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
